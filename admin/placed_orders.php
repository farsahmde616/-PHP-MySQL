      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> السعر الكلي : <span>$<?= $fetch_orders['total_price']; ?></span> </p>
                  <p> طريقة الدفع او السداد : <span><?= $fetch_orders['method']; ?></span> </p>
                  <form action="" method="POST">
                     ...
                     <div class="flex-btn">
                        ...
                        <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">حذف</a>
                     </div>
                  </form>
               </div>
         <?php
